...
#pragma mark - NHMemebrGroupData

@interface NHMemebrGroupData : NSObject
...
@implementation NHMemebrGroupData

@end

@interface NHMemberGroupView()<UICollectionViewDataSource,UICollectionViewDelegate,NIMTeamCardHeaderCellDelegate>
...
@implementation NHMemberGroupView
...
//    NSInteger sectionNumber = self.data.count;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NHMemebrGroupData *data = [self dataAtIndexPath:indexPath];
...
- (NHMemebrGroupData *)dataAtIndexPath:(NSIndexPath*)indexpath{
...
- (void)cellDidSelected:(NIMTeamCardHeaderCell *)cell{
    ...
    NHMemebrGroupData *groupData = [self dataAtIndexPath:indexPath];
...
- (void)makeData{
    ...
    for (NSString *uid in self.uids) {
        NHMemebrGroupData *groupData = [[NHMemebrGroupData alloc] init];
